...
Author:         Ritik Raj Chauhan, Pruthviraj P
System:         Ubuntu 20.04.4 LTS, freeglut3 3.2.2
***********************************************************************/
...
#define SPEED 0.5	 //determines the speed of game
...
void keyboard(unsigned char key, int x, int y)
{
	...
	case 'n':	
			...
			case 1:
				...
				break;
			case 31:
				cout<<"next"<<endl;//Continue here edit program
				i_plane=0;
				page=32;
				break;
			case 32:
...
void draw_credit_text()
{
	...
	strcpy(string[3],"_____AIEMS Bengaluru_____");
	strcpy(string[2],"Thank you!");
	strcpy(string[1],"Ritik Raj Chauhan (1AR19CS044)");
	strcpy(string[0],"Pruthvi Raj P (1AR19CS042)");
	strcpy(string[4],"");
...
void draw_menu_text()
{
	...
	strcpy(string_menu[0],"Play! (P)");
	strcpy(string_menu[1],"Settings (S)");
	strcpy(string_menu[2],"Instructions (I)");
	strcpy(string_menu[3],"Credit (C)");
	strcpy(string_menu[4],"High Scores (H)");
	strcpy(string_menu[5],"Exit... (E)");
...
void RenderScene()
{
	...
	if(page==1)
	{
		...
		if(!full)
		{
			drawString(-150.0,65.0,0.0,"Amruta Institute of Engineering and Management Sciences, Bangalore");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-90.0,55.0,0.0,"Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-120.0,45.0,0.0,"Ritik Raj Chauhan - 1AR19CS044");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-115.0,35.0,0.0,"Pruthviraj P - 1AR19CS042");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(130.0,-50.0,0.0,"Next!  (N)");
		}
		else
		{
			drawString(-135.0,65.0,0.0,"Amruta Institute of Engineering and Management Sciences, Bangalore");//-105-->-125
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-80.0,55.0,0.0,"Made By:");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-98.0,45.0,0.0,"Ritik Raj Chauhan - 1AR19CS044");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(-92.0,35.0,0.0,"Pruthviraj P - 1AR19CS042");
			setFont(GLUT_BITMAP_TIMES_ROMAN_24);
			glColor3f(0.0,0.0,0.0);
			drawString(125.0,-50.0,0.0,"Click Here!");
			setFont(GLUT_BITMAP_HELVETICA_18);
			glColor3f(0.0,0.0,0.0);
			drawString(135.0,-55.0,0.0,"Next!  (N)");
		}
